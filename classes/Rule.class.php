...
/**
 * This class defines sets of Rules which can be applied to qualification structures
 *
...
/**
 * This class defines a Rule which can be applied to qualification structures
 *
 * @copyright   2011-2017 Bedford College, 2017 onwards Conn Warwicker
 * @package     block_gradetracker
 * @version     2.0
...
/**
 * This class defines a step inside a Rule
 *
 * @copyright   2011-2017 Bedford College, 2017 onwards Conn Warwicker
 * @package     block_gradetracker
 * @version     2.0
...
/**
 * This class defines a condition to be met, inside a step of a rule
 *
 * @copyright   2011-2017 Bedford College, 2017 onwards Conn Warwicker
 * @package     block_gradetracker
 * @version     2.0
...
class RuleStepCondition {
    ...
    public function isMet($params) {
        ...
        if (strlen($this->conditionArray['v1']) > 0) {
            ...
            } else if (is_numeric($this->conditionArray['v1'])) {
        ...
        if (strlen($this->conditionArray['v2']) > 0) {
            ...
            } else if (is_numeric($this->conditionArray['v2'])) {
    ...
    protected function comparison_is_equal($v1, $v2) {
        ...
        } else if (is_scalar($v1) && is_scalar($v2)) {
...
/**
 * This class defines an action to be taken in a step of a rule, if the condition(s) are met
 *
 * @copyright   2011-2017 Bedford College, 2017 onwards Conn Warwicker
 * @package     block_gradetracker
 * @version     2.0
...
/**
 * This is a general rule object class which is extended into more specific classes, such as qual, unit and criterion
 *
 * @copyright   2011-2017 Bedford College, 2017 onwards Conn Warwicker
 * @package     block_gradetracker
 * @version     2.0
...
/**
 * This class defines a qualification object inside a rule
 *
 * @copyright   2011-2017 Bedford College, 2017 onwards Conn Warwicker
 * @package     block_gradetracker
 * @version     2.0
...
/**
 * This class definesa unit object inside a rule
 *
 * @copyright   2011-2017 Bedford College, 2017 onwards Conn Warwicker
 * @package     block_gradetracker
 * @version     2.0
...
class RuleObject_Unit extends RuleObject {
    ...
    public function getCriteria($args) {
        ...
        if (!$this->unitObject || !$this->unitObject->isValid()) {
            return false;
        }
...
/**
 * This class defines a criterion object inside a rule
 *
 * @copyright   2011-2017 Bedford College, 2017 onwards Conn Warwicker
 * @package     block_gradetracker
 * @version     2.0
...
class RuleObject_Criterion extends RuleObject {
    ...
    public function getAward() {
        ...
        if (!$this->criterionObject || !$this->criterionObject->isValid()) {
            return false;
        }
...
/**
 * This class is used to verify if rules are valid
 *
 * @copyright   2011-2017 Bedford College, 2017 onwards Conn Warwicker
 * @package     block_gradetracker
 * @version     2.0
