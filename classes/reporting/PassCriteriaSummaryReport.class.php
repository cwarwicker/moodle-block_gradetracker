                            ...
                            foreach ($quals as $qual) {
                                ...
                                if ($data) {
                                    ...
                                    foreach ($data as $student) {
                                        ...
                                        } else if ($studentWeightingPercentage < \GT\Reports\CriteriaProgressReport::STATUS_POOR) {
                                            $statusArray[\GT\Reports\CriteriaProgressReport::STATUS_POOR]++;
                                        } else if ($studentWeightingPercentage < \GT\Reports\CriteriaProgressReport::STATUS_GOOD) {
                                            $statusArray[\GT\Reports\CriteriaProgressReport::STATUS_GOOD]++;
                                        } else if ($studentWeightingPercentage <= \GT\Reports\CriteriaProgressReport::STATUS_EXCELLENT) {
                                        ...
                                        } else if ($studentPassPercentageBest < \GT\Reports\CriteriaProgressReport::STATUS_POOR) {
                                            $passStatusArray[\GT\Reports\CriteriaProgressReport::STATUS_POOR]++;
                                        } else if ($studentPassPercentageBest < \GT\Reports\CriteriaProgressReport::STATUS_GOOD) {
                                            $passStatusArray[\GT\Reports\CriteriaProgressReport::STATUS_GOOD]++;
                                        } else if ($studentPassPercentageBest <= \GT\Reports\CriteriaProgressReport::STATUS_EXCELLENT) {
