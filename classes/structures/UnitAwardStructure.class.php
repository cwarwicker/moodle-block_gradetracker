...
class UnitAwardStructure {
    ...
    /**
     * Get a UnitAwardStructure object by its name and qualstructureid
     * @param $name
    ...
    public static function findByName($name, $qualStructureID) {
        ...
        $record = $DB->get_record('bcgt_unit_award_structures', array('name' => $name, 'qualstructureid' => $qualStructureID));
        return ($record) ? new UnitAwardStructure($record->id) : false;
