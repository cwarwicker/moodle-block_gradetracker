...
$string['breadcrumbs:config:units:import'] = 'Import a Unit';
...
$string['config:grid:showucas'] = 'Show UCAS';
$string['config:grid:showucas:desc'] = 'Show the UCAS points of predicted awards at the bottom of the grid';
...
$string['importnewstructure'] = 'Import Structure';
...
$string['system:count:staff'] = 'No. Teachers';
$string['system:count:students'] = 'No. Students';
...
$string['unitsimported'] = 'Unit(s) Imported';
