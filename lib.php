...
function gt_display_debug_section() {
    ...
    if (is_siteadmin()) {
        ...
        echo "</a>";
        echo "<td>";
        echo "<a href='{$CFG->wwwroot}/blocks/gradetracker/download.php?f=".\gt_create_data_path_code( '/debug/'.$USER->id.'.txt' )."&t=".time()."' class='gt_refresh_url_time' target='_blank' title='".get_string('viewlogs', 'block_gradetracker')."'>";
